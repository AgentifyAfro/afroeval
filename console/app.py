...
with tab_configure:
    ...
    with col2:
        ...
        st.info(
            ...
            "Seed packs are generated by `scripts/seed_benchmarks.py`. "
            "Full SME-validated packs available from Week 3."
        )
        pack_ids = st.multiselect(
            "Select Benchmark Packs",
            options=["mobile_money_sw_v1.0.0", "customer_service_yo_v1.0.0"],
            help="Select one or more versioned benchmark packs.",
        )
