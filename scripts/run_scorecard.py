...
Usage:
    ...
    # Multiple packs
    python scripts/run_scorecard.py --packs customer_service_yo_v1.0.0 --packs community_health_am_v1.2.0
...
def _print_score_box(scorecard: dict) -> None:
    ...
    if scorecard.get("african_fabrication_detected"):
        conf_str += f"  {_YELLOW}⚠ African Fabrication Detected{_RESET}"
